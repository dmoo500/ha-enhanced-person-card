"use strict";(()=>{var w=class extends HTMLElement{constructor(){super();this._hass=null;this._config=null;this._initialized=!1;this._lastEntityState="";this._lastEntityAttributes=null;this._lastDevicesData=[];this._lastConfigHash="";this._rendered=!1;this._usedSensors=new Set;this.attachShadow({mode:"open"}),this._render()}set hass(e){this._hass=e||null,this._initialized&&this._updateIfNeeded()}get hass(){return this._hass||void 0}setConfig(e){var r,a,i,n,c,d,o,u;if(!e)throw new Error("Invalid configuration");if(!e.entity)throw new Error("You need to define an entity");let t=this._config;this._config=e,this._initialized=!0,this._lastConfigHash="",this._rendered=!1,(((r=t==null?void 0:t.grid_options)==null?void 0:r.rows)!==((a=e==null?void 0:e.grid_options)==null?void 0:a.rows)||((i=t==null?void 0:t.layout_options)==null?void 0:i.grid_rows)!==((n=e==null?void 0:e.layout_options)==null?void 0:n.grid_rows)||(t==null?void 0:t.grid_rows)!==(e==null?void 0:e.grid_rows)||((c=t==null?void 0:t.grid_options)==null?void 0:c.columns)!==((d=e==null?void 0:e.grid_options)==null?void 0:d.columns)||((o=t==null?void 0:t.layout_options)==null?void 0:o.grid_columns)!==((u=e==null?void 0:e.layout_options)==null?void 0:u.grid_columns)||(t==null?void 0:t.grid_columns)!==(e==null?void 0:e.grid_columns))&&this._updateDynamicStyles(),this._hass?this._updateIfNeeded():this._render()}getCardSize(){var e,t,s,r;return(t=(e=this._config)==null?void 0:e.grid_options)!=null&&t.rows?Number(this._config.grid_options.rows):(r=(s=this._config)==null?void 0:s.layout_options)!=null&&r.grid_rows?Number(this._config.layout_options.grid_rows):this._config&&"grid_rows"in this._config?Number(this._config.grid_rows):3}getCardColumns(){var e,t,s,r;return((t=(e=this._config)==null?void 0:e.grid_options)==null?void 0:t.columns)!==void 0?this._config.grid_options.columns:((r=(s=this._config)==null?void 0:s.layout_options)==null?void 0:r.grid_columns)!==void 0?this._config.layout_options.grid_columns:this._config&&"grid_columns"in this._config&&this._config.grid_columns!==void 0?this._config.grid_columns:1}_updateDynamicStyles(){var d,o,u,l,_;if(!this.shadowRoot)return;let e=((o=(d=this._config)==null?void 0:d.grid_options)==null?void 0:o.rows)||((l=(u=this._config)==null?void 0:u.layout_options)==null?void 0:l.grid_rows)||((_=this._config)==null?void 0:_.grid_rows)||this.getCardSize(),t=this.getCardColumns(),s=t==="full"?12:typeof t=="number"?t:1,r=40;s===1?r=Math.max(60,e*20+40):s===2?r=Math.max(70,e*22+50):s>=3&&s<=5?r=Math.max(80,e*25+60):s>=6&&s<=8?r=Math.max(55,e*15+40):s>=9&&(r=Math.max(40,e*8+25));let a=Math.max(1,e);r=r+(a-1)*8;let i,n;if(s>=9?(i=30,n=60):s>=6?(i=40,n=90):s>=3?(i=60,n=140):(i=50,n=120),r=Math.max(i,Math.min(n,r)),this.style.setProperty("--dynamic-icon-size",`${r}px`),t==="full"?(this.style.setProperty("--card-width","100%"),this.style.setProperty("--card-flex-grow","1"),this.style.setProperty("--card-grid-column","1 / -1"),this.style.setProperty("--card-max-width","none"),this.style.setProperty("--card-margin","0")):typeof t=="number"&&t>1?(this.style.setProperty("--card-grid-column",`span ${t}`),this.style.removeProperty("--card-width"),this.style.removeProperty("--card-flex-grow"),this.style.removeProperty("--card-max-width"),this.style.removeProperty("--card-margin")):(this.style.removeProperty("--card-width"),this.style.removeProperty("--card-flex-grow"),this.style.removeProperty("--card-grid-column"),this.style.removeProperty("--card-max-width"),this.style.removeProperty("--card-margin")),e>1){let f=`${e*80}px`;this.style.setProperty("--dynamic-height",f)}let c;t==="full"||s>=12?c="12%":s>=9?c="15%":s>=6?c="20%":s>=3?c="25%":c="30%",this.style.setProperty("--person-left-width",c)}_updateIfNeeded(){if(!this._hass||!this._config||!this._initialized){this._render();return}let e=this._config.entity,t=this._hass.states[e];if(!t){this._render();return}let s=t.state,r=t.attributes,a=this._getPersonDevices(t),i=JSON.stringify({name:this._config.name,image:this._config.image,icon:this._config.icon,show_name:this._config.show_name,show_state:this._config.show_state,show_devices:this._config.show_devices,badge_style:this._config.badge_style,device_attributes:this._config.device_attributes}),n=this._lastEntityState!==s,c=JSON.stringify(this._lastEntityAttributes)!==JSON.stringify(r),d=JSON.stringify(this._lastDevicesData)!==JSON.stringify(a),o=this._lastConfigHash!==i;(n||c||d||o||!this._rendered)&&(this._lastEntityState=s,this._lastEntityAttributes=r,this._lastDevicesData=a,this._lastConfigHash=i,this._render())}_getPersonDevices(e){if(!this._hass||!e)return[];let t=this._config,s=(t==null?void 0:t.excluded_entities)||[],r=e.entity_id,a=[];return e.attributes.device_trackers&&Array.isArray(e.attributes.device_trackers)&&e.attributes.device_trackers.forEach(i=>{if(!s.includes(i)){let n=this._hass.states[i];n&&n.attributes.source_type&&a.push(n)}}),a.length===0&&Object.values(this._hass.states).forEach(i=>{i.entity_id.startsWith("device_tracker.")&&!s.includes(i.entity_id)&&i.attributes.source_type&&i.attributes.person===r&&a.push(i)}),a.sort((i,n)=>{let c=i.attributes.friendly_name||i.entity_id;return(n.attributes.friendly_name||n.entity_id).length-c.length}),a}_getAttributeLabel(e){return{battery_level:"Battery",gps_accuracy:"GPS Accuracy",source_type:"Source",zone:"Zone",latitude:"Latitude",longitude:"Longitude",altitude:"Altitude",course:"Course",speed:"Speed",ip:"IP Address",hostname:"Hostname",mac:"MAC Address",last_seen:"Last Seen"}[e]||e}_getAttributeIcon(e,t){switch(e){case"battery_level":let s=parseInt(t);return s>80?{icon:"mdi:battery",color:"#4caf50"}:s>60?{icon:"mdi:battery-60",color:"#8bc34a"}:s>40?{icon:"mdi:battery-40",color:"#ff9800"}:s>20?{icon:"mdi:battery-20",color:"#ff5722"}:{icon:"mdi:battery-alert",color:"#f44336"};case"gps_accuracy":let r=parseInt(t);return r<=10?{icon:"mdi:crosshairs-gps",color:"#4caf50"}:r<=50?{icon:"mdi:crosshairs-gps",color:"#ff9800"}:{icon:"mdi:crosshairs-question",color:"#f44336"};case"source_type":switch(t){case"gps":return{icon:"mdi:crosshairs-gps",color:"#2196f3"};case"bluetooth":return{icon:"mdi:bluetooth",color:"#3f51b5"};case"router":return{icon:"mdi:router-wireless",color:"#607d8b"};default:return{icon:"mdi:help-circle",color:"#757575"}}case"altitude":return{icon:"mdi:elevation-rise",color:"#795548"};case"course":return{icon:"mdi:compass",color:"#9c27b0"};case"speed":let a=parseInt(t);return a>50?{icon:"mdi:speedometer",color:"#f44336"}:a>10?{icon:"mdi:speedometer-medium",color:"#ff9800"}:{icon:"mdi:speedometer-slow",color:"#4caf50"};case"zone":return{icon:"mdi:map-marker-radius",color:"#2196f3"};case"latitude":return{icon:"mdi:latitude",color:"#9c27b0"};case"longitude":return{icon:"mdi:longitude",color:"#9c27b0"};case"ip":return{icon:"mdi:ip-network",color:"#607d8b"};case"hostname":return{icon:"mdi:dns",color:"#607d8b"};case"mac":return{icon:"mdi:network",color:"#607d8b"};case"last_seen":return{icon:"mdi:clock-outline",color:"#757575"};default:return{icon:"mdi:information-outline",color:"#757575"}}}_getAttributeDisplayValue(e,t){switch(e){case"battery_level":return`${t}%`;case"gps_accuracy":return`${t}m`;case"altitude":return`${t}m`;case"speed":return`${t} km/h`;case"course":return`${t}\xB0`;case"zone":return String(t).replace(/_/g," ");case"latitude":return`${parseFloat(t).toFixed(4)}\xB0`;case"longitude":return`${parseFloat(t).toFixed(4)}\xB0`;case"ip":return String(t);case"hostname":return String(t);case"mac":return String(t).toUpperCase();case"last_seen":if(t&&(t.includes("T")||t.includes("-")))try{return new Date(t).toLocaleTimeString()}catch{return String(t)}return String(t);default:return String(t)}}_render(){if(!this.shadowRoot){console.warn("\u26A0\uFE0F Shadow Root not available");return}if(this._usedSensors.clear(),!this._initialized||!this._config){this.shadowRoot.innerHTML=this._getLoadingHTML();return}if(!this._hass){this.shadowRoot.innerHTML=this._getNoHassHTML();return}let e=this._config.entity,t=this._hass.states[e];if(!t){this.shadowRoot.innerHTML=this._getEntityNotFoundHTML(e);return}this.shadowRoot.innerHTML=this._getCardHTML(t),this._attachEventListeners(),this._updateDynamicStyles(),this._rendered=!0}_getLoadingHTML(){return`
    ...
    `}_getCardHTML(e){let t=this._config,s=t.name||e.attributes.friendly_name||t.entity,r=e.state,a=t.image||e.attributes.entity_picture,i=t.icon,n=t.show_name!==!1,c=t.show_state!==!1,d=t.show_devices!==!1,o=this._getStateText(r),u=this._getStateClass(r),l=this._getPersonDevices(e);return`
      ${this._getStyles()}
    ...
    `}_renderIcon(e,t,s){return e?`<img src="${e}" alt="${s}" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';" />
        <div class="fallback-icon" style="display: none;">${t?this._renderMDI(t):this._renderMDI("mdi:account")}</div>`:t?`<div class="fallback-icon">${this._renderMDI(t)}</div>`:`<div class="fallback-icon">${this._renderMDI("mdi:account")}</div>`}_renderMDI(e){return e.startsWith("mdi:")?`<ha-icon icon="${e}"></ha-icon>`:e}_getStateText(e){var a;let t=((a=this._config)==null?void 0:a.badge_style)||"icon_text",s=this._getStateIcon(e),r=this._getLocationDisplayName(e);switch(t){case"icon_only":return this._renderMDI(s);case"text_only":return r;case"icon_text":default:return`${this._renderMDI(s)} ${r}`}}_getStateIcon(e){switch(e){case"home":return"mdi:home";case"not_home":return"mdi:home-export-outline";case"unknown":return"mdi:help-circle-outline";default:return"mdi:map-marker"}}_getLocationDisplayName(e){if(!e||e==="unknown")return"Unknown";switch(e){case"home":return"Home";case"not_home":return"Away";case"unknown":return"Unknown"}let t=e.replace(/_/g," ");return t=t.split(" ").map(s=>s.charAt(0).toUpperCase()+s.slice(1).toLowerCase()).join(" "),t}_getStateClass(e){switch(e){case"home":return"state-home";case"not_home":return"state-away";default:return"state-unknown"}}_renderDevice(e){let t=e.attributes.friendly_name||e.entity_id,s=this._getDeviceIcon(e),r=this._config.device_attributes||["battery_level","gps_accuracy","source_type"],a=[];return r.forEach(i=>{if(i==="zone"){let n=e.state,c=this._formatDeviceState(n),d=this._getAttributeIcon("zone",n),o=this._getAttributeLabel("zone");a.push({name:i,label:o,value:n,displayValue:c,icon:d,entityName:t})}else{let n=this._getAttributeEntriesForDevice(e,i);a.push(...n)}}),`
    ...
    `}_getAttributeEntriesForDevice(e,t){let s=[],r=new Set;if(!this._hass||!this._hass.states)return s;let a=e.attributes.device_id,i=e.entity_id,n=e.attributes.friendly_name||e.entity_id.replace("device_tracker.",""),d={battery_level:["battery_level","battery"],signal_strength:["signal_strength","wifi_signal","signal"],gps_accuracy:["gps_accuracy","accuracy"]}[t]||[t];return Object.values(this._hass.states).forEach(o=>{if(!o.entity_id.startsWith("sensor."))return;let u=o.attributes.friendly_name||o.entity_id;if(r.has(u))return;let l=!1;if(a&&o.attributes.device_id===a&&(l=!0),!l){let h=o.entity_id.toLowerCase(),b=(o.attributes.friendly_name||"").toLowerCase(),y=i.replace("device_tracker.","").toLowerCase(),v=(n||"").toLowerCase(),S=Object.values(this._hass.states).filter(p=>p.entity_id.startsWith("device_tracker.")).map(p=>({entity_id:p.entity_id.replace("device_tracker.","").toLowerCase(),friendly_name:(p.attributes.friendly_name||"").toLowerCase(),full_entity:p.entity_id})),C=h===`sensor.${y}`||h.startsWith(`sensor.${y}_`),L=!1;if(C){for(let p of S)if(p.entity_id!==y&&p.entity_id.includes(y)&&(h.includes(p.entity_id)||b.includes(p.friendly_name))){L=!0;break}}if(C&&!L)l=!0;else if(!l&&v&&v.length>3){let p=b.includes(v)||h.includes(v.replace(/\s+/g,"_")),z=!1;if(p){for(let x of S)if(x.friendly_name!==v&&x.friendly_name.length>v.length&&(b.includes(x.friendly_name)||h.includes(x.friendly_name.replace(/\s+/g,"_")))){z=!0;break}}p&&!z&&(l=!0)}}if(!l)return;let _=o.entity_id.toLowerCase(),f=(o.attributes.friendly_name||"").toLowerCase();if(!d.some(h=>_.includes(h)||f.includes(h))||this._usedSensors.has(o.entity_id)||["battery_state","charging_state","power_state"].some(h=>_.includes(h)||f.includes(h)))return;let g=o.state;if(g&&g!=="unknown"&&g!=="unavailable"){let h=this._getAttributeDisplayValue(t,g),b=this._getAttributeIcon(t,g),y=this._getAttributeLabel(t);s.push({name:t,label:y,value:g,displayValue:h,icon:b,entityName:u}),r.add(u),this._usedSensors.add(o.entity_id)}}),s}_formatDeviceState(e){if(!e||e==="unknown")return"Unknown";switch(e){case"home":return"Home";case"not_home":return"Away";case"unknown":return"Unknown"}let t=e.replace(/_/g," ");return t=t.split(" ").map(s=>s.charAt(0).toUpperCase()+s.slice(1).toLowerCase()).join(" "),t}_getDeviceIcon(e){return e.entity_id.startsWith("device_tracker.")?e.attributes.source_type==="gps"?"mdi:cellphone":e.attributes.source_type==="bluetooth"?"mdi:bluetooth":e.attributes.source_type==="router"?"mdi:router-wireless":"mdi:crosshairs-gps":"mdi:devices"}_getStyles(){var s,r,a,i,n;let e=((r=(s=this._config)==null?void 0:s.grid_options)==null?void 0:r.rows)||((i=(a=this._config)==null?void 0:a.layout_options)==null?void 0:i.grid_rows)||((n=this._config)==null?void 0:n.grid_rows)||this.getCardSize(),t="100%";return`
      <style>
        host {
            display: block;
            border-radius: 16px;
        ...
        .person-card {
          ...
          min-height: ${e>1?t:"var(--card-min-height, 120px)"};
          ${e>1?`height: ${t} !important;`:""}
